    ...
    return(
        <div className={classes.history_page}>
            ...
            <div className={classes.info_section}>
                ...
                <img className={classes.image} src={canadia} width="800" height="556"/>
            </div>
            <div className={classes.info_section}>
                <img className={classes.image} src={brwn_fossil} width="800" height="544"/>
                <div className={classes.text_box}>
                    <p className={classes.text}>
            ...
            <div className={classes.info_section}>
                ...
                <img className={classes.image} src={interpretations} width="800" height="556"/>
            </div>
        </div>
    );
}